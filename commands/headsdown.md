...
**No argument or "status":** Display the availability context above in a clear, concise format. Show mode, status, time remaining, and availability state. If not authenticated, suggest running `/headsdown auth`.
